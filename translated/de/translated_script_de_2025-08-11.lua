...
local MainTab = Window:AddTab({ Title = "Haupt", Icon = "zap" })
local SettingsTab = Window:AddTab({ Title = "Einstellungen", Icon = "settings" })
...
local function createPerformanceOverlay()
    ...
    fluentToggleButton.Text = "Benutzeroberfläche ausblenden"
...
local AutoBuySpinsToggle = MainTab:AddToggle("AutoBuySpins", {
    Title = "Automatische Kaufdrehungen",
...
local AutoMachineToggle = MainTab:AddToggle("AutoMachine", {
    Title = "Automatische Entsperrung de...",
...
SettingsTab:AddButton({
    Title = "Sitzungsstatistiken zurücks...",
    Callback = function()
        _G.planeconfig.beforecash = LocalPlayer.leaderstats.Cash.Value
        _G.planeconfig.sessionstart = tick()
        ...
        Fluent:Notify({
            Title = "Sitzungs-Reset",
            Content = "Die Bargeldverfolgung wurde zurückgesetzt!",
            Duration = 3
        })
    end
})
...
Fluent:Notify({
    Title = "Skript geladen!",
    Content = "Alle Funktionen einsatzbereit! W zu VateQ",
    Duration = 5
})