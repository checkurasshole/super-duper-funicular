...
local MainTab = Window:AddTab({ Title = "Principales", Icon = "zap" })
local SettingsTab = Window:AddTab({ Title = "Paramètres", Icon = "settings" })
...
local function createPerformanceOverlay()
    ...
    performanceGui.Name = "Superposition des performances"
    ...
    title.Text = "REMARQUE DE SESSION"
    ...
    toggleButton.Text = "Mettre en place une superposition"
    ...
    fluentToggleButton.Text = "Cacher l'interface utilisateur"
...
local AutoMachineToggle = MainTab:AddToggle("AutoMachine", {
    Title = "Déverrouillage automatique ...",
...
SettingsTab:AddButton({
    Title = "Réinitialiser les statistiq...",
    Callback = function()
        _G.planeconfig.beforecash = LocalPlayer.leaderstats.Cash.Value
        _G.planeconfig.sessionstart = tick()
        ...
        Fluent:Notify({
            Title = "Réinitialisation de la session",
            Content = "Le suivi des espèces a été réinitialisé !",
            Duration = 3
        })
    end
})
...
Fluent:Notify({
    Title = "Script chargé !",
    Content = "Toutes les fonctionnalités sont prêtes à l'emploi! W to VateQ",
    Duration = 5
})