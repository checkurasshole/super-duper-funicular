...
local MainTab = Window:AddTab({ Title = "メイン", Icon = "zap" })
local SettingsTab = Window:AddTab({ Title = "設定", Icon = "settings" })
...
local function createPerformanceOverlay()
    ...
    toggleButton.Text = "オーバーレイを切り替える。"
...
Fluent:Notify({
    Title = "スクリプトが読み込まれました！",
    Content = "すべての機能を使用する準備ができています！ WからVateQ",
    Duration = 5
})