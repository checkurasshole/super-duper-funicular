...
local SettingsTab = Window:AddTab({ Title = "Configuración", Icon = "settings" })
...
local function createPerformanceOverlay()
    ...
    title.Text = "TRACKER DEL PERÍODO DE SESIONES"
    ...
    toggleButton.Text = "Conmutar overlay"
    ...
    fluentToggleButton.Text = "Ocultar la interfaz de usuario"
...
local AutoMachineToggle = MainTab:AddToggle("AutoMachine", {
    Title = "Desbloquear automáticamente...",
...
SettingsTab:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({
            ...
            Content = "¡Se ha restablecido el rastreo de efectivo!",
            Duration = 3
        })
    end
})
...
Fluent:Notify({
    ...
    Content = "Todas las características listas para usar! W a VateQ",
    Duration = 5
})